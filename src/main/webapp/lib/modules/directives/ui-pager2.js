...
//							pageOffset = 0;
//						}
//						var ul = $("<div class='pages'></div>");
//						var first;
//						if (curPage == 1) {
//							first = $("<a class='first' href='javascript:void(0);'>首页</a>");
//						} else {
//							first = $("<a class='first' href='javascript:void(0);' v-click='" + callback + "(" + 0 * pager.limit + ", " + pager.limit + ")'>首页</a>");
//						}
//						ul.append(first);
//						var prev;
//						if (curPage == 1) {
...
//						} else {
//							prev = $("<a class='prev' href='javascript:void(0);' v-click='" + callback + "(" + (curPage - 2) * pager.limit + ", " + pager.limit + ")'>上一页</a>");
//						}
//						ul.append(prev);
//						for (var i = 1; i <= pageLimit; i++) {
//								var page;
//								if (curPage == (i + pageOffset)) {
//									page = "<a href='javascript:void(0);'>" + (i + pageOffset) + "</a>";
//								} else {
//									page = "<a href='javascript:void(0);' v-click='" + callback + "(" + (i + pageOffset - 1) * pager.limit + ", " + pager.limit + ")'>" + (i + pageOffset) + "</a>";
//								}
//								ul.append(page);
//						}
//						var next;
...
//						} else {
//							next = $("<a class='next' href='javascript:void(0);' v-click='" + callback + "(" + curPage * pager.limit + ", " + pager.limit + ")'>下一页</a>");
//						}
//						var last;
//						if (curPage == pageCapacity) {
//							last = $("<a class='last' href='javascript:void(0);'>尾页</a>");
//						} else {
//							last = $("<a class='last' href='javascript:void(0);' v-click='" + callback + "(" + (pageCapacity-1) * pager.limit + ", " + pager.limit + ")'>尾页</a>");
//						}
//						ul.append(next);
//						ul.append(last);
//						$(elem).append(ul);
