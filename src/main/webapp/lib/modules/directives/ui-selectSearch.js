            ...
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    function showTotalNum(thisDom) {
                        if (thisDom.val() == "") {
                            var queryOption = thisDom.siblings('.searchSelectDrop').find('.searchSelectOptionText');
                        } else {
                            var queryOption = thisDom.siblings('.searchSelectDrop').find('.searchSelectOptionText:searchSelectContains("' + thisDom.val() + '")');
                        }
