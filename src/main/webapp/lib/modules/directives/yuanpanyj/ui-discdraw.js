...
(function(window, vx, undefined) {'use strict';
	...
	function($compile) {
		return {
			template : '<div id="discdraw">' + '<img class="discbg" src="images/disc-rotate.gif" viewBox="0 0 352 30" />' + '<div class="arrow"></div>' + '<div class="draw-btn">' + '<span></span>' + '</div>' + '<div class="cover"></div><div class="resultTip"><span>aaa</span>' + '<a href="#"  class="btn btn-info btn-large">确定</a>' + '</div>' + '</div>',
			restrict : 'CA',
