/**
 * @author xuxihai
 *  <div  v-model="selectObj" ui-carousel="PrdList" class="zhiquts_01 add" incoming-field="des;rate" select-call="select(index)></div>
 *  <input  v-model="selectObj" ui-carousel="PrdList" class="zhiquts_01 add" incoming-field="des;rate" select-call="select(index)/>
