...
var $vLazyLoad_Modules = [{
	...
	name: 'textAngular',
	files: ['lib/plugins/textAngular-master/dist/textAngular.css', 'lib/plugins/textAngular-master/dist/textAngular-rangy.min.js', 'lib/plugins/textAngular-master/dist/textAngular-sanitize.min.js', 'lib/plugins/textAngular/dist/textAngular.min.js']
...
var $vLazyLoad_NoModules = {
	...
	_wysiwyg: ['lib/plugins/bootstrap-wysiwyg/bootstrap-wysiwyg.js', 'lib/plugins/bootstrap-wysiwyg/external/jquery.hotkeys.js',"css/font-awesome/css/font-awesome.css"],
	...
	_swiper: ['lib/plugins/swiper/swiper-3.4.2.jquery.min.js','lib/plugins/swiper/swiper-3.4.2.min.css'],
	_ztree: ['lib/modules/directives/ui-checkboxtree.js', 'css/ui-checkboxtree.css'],
	_froala: [
		'lib/plugins/froala-editor/css/font-awesome.css',
		'lib/plugins/froala-editor/css/froala_page.min.css',
		'lib/plugins/froala-editor/css/font-awesome.min.css',
		'lib/plugins/froala-editor/css/froala_editor.css',
		'lib/plugins/froala-editor/js/plugins/tables.min.js',
		'lib/plugins/froala-editor/js/plugins/lists.min.js',
		'lib/plugins/froala-editor/js/plugins/colors.min.js',
		'lib/plugins/froala-editor/js/plugins/media_manager.min.js',
		'lib/plugins/froala-editor/js/plugins/font_family.min.js',
		'lib/plugins/froala-editor/js/plugins/font_size.min.js',
		'lib/plugins/froala-editor/js/plugins/block_styles.min.js',
		'lib/plugins/froala-editor/js/plugins/video.min.js'
		
	],
	_writeObject:['lib/writeObject.js','css/objectStyle.css']
};
